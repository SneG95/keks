              ...
              <ul className="catalog__list">
                ...
                <li className="catalog__item">
                  <div className="card-item card-item--big">
                    <a className="card-item__img-link" href="#">
                      <div className="card-item__img-wrapper">
                        <picture>
                          ...
                          <img src="img/content/blueberry-muffin.jpg" srcSet="img/content/blueberry-muffin@2x.jpg 2x" width="326" height="332" alt="Тарт голубика." />
                        </picture>
                      </div>
                    </a>
                    ...
                    </button><span className="card-item__price">1 100 p</span>
                    <a className="card-item__link" href="#">
                ...
                <li className="catalog__item">
                  <div className="card-item card-item--big">
                    <a className="card-item__img-link" href="#">
                      <div className="card-item__img-wrapper">
                        <picture>
                          ...
                          <img src="img/content/cupcake-chocolate.jpg" srcSet="img/content/cupcake-chocolate@2x.jpg 2x" width="326" height="332" alt="Кекс шоколад." />
                        </picture>
                      </div>
                    </a>
                    <button className="card-item__favorites"><span className="visually-hidden">Добавить в избранное</span>
                    ...
                    </button><span className="card-item__price">700 p</span>
                    <a className="card-item__link" href="#">
                    ...
                    <a className="card-item__img-link" href="#">
                      <div className="card-item__img-wrapper">
                        <picture>
                          ...
                          <img src="img/content/cheesecake-vegetarian.jpg" srcSet="img/content/cheesecake-vegetarian@2x.jpg 2x" width="326" height="332" alt="Чизкейк вегетарианский." />
                        </picture>
                      </div>
                    </a>
                    <button className="card-item__favorites"><span className="visually-hidden">Добавить в избранное</span>
                ...
                <li className="catalog__item">
                  <div className="card-item card-item--big">
                    ...
                    </button><span className="card-item__price">3 700 p</span>
                    <a className="card-item__link" href="#">
